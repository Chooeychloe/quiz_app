import { Award, Clock, Medal, RefreshCw, Target } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <div className="mb-8">
          ...
          <button
            className="inline-flex items-center space-x-3 px-8 py-4 bg-linear-to-r 
            from-blue-500 to-purple-600 text-white rounded-xl hover:
          ...
          >
            <RefreshCw className="pr-2" size={24} />
            Take Quiz Again
          </button>
        </div>
      </div>
